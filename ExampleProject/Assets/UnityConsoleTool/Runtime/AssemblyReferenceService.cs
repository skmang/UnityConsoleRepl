...
//
//         public HashSet<string> ImplementationAssemblyPaths => implementationAssemblyPaths;
//         public HashSet<MetadataReference> LoadedImplementationAssemblies => loadedImplementationAssemblies;
//         public HashSet<MetadataReference> LoadedReferenceAssemblies => loadedReferenceAssemblies;
...
//             this.referenceAssemblyPaths = new HashSet<string>();
//             this.implementationAssemblyPaths = new HashSet<string>();
//             this.sharedFrameworkImplementationAssemblyPaths = new HashSet<string>();
